...
def test_close_messages_same_window():
    ...
    messages = [
        make_scored(message_id=1, timestamp="2026-01-01T12:00:00Z"),
        make_scored(message_id=2, timestamp="2026-01-01T12:30:00Z"),
        make_scored(message_id=3, timestamp="2026-01-01T13:00:00Z"),
    ]
...
def test_gap_creates_new_window():
    ...
    messages = [
        make_scored(message_id=1, timestamp="2026-01-01T08:00:00Z"),
        make_scored(message_id=2, timestamp="2026-01-01T08:30:00Z"),
        make_scored(message_id=3, timestamp="2026-01-01T14:00:00Z"),  # 5.5h gap
    ]
    windows = create_windows(messages, gap_hours=4)
...
def test_channel_change_creates_new_window():
    ...
    messages = [
        make_scored(message_id=1, channel_id=100, timestamp="2026-01-01T12:00:00Z"),
        make_scored(message_id=2, channel_id=200, timestamp="2026-01-01T12:05:00Z"),
    ]
    windows = create_windows(messages, gap_hours=4)
    assert len(windows) == 2
...
def test_window_quality_score_is_mean():
    messages = [
        make_scored(message_id=1, score=0.8, timestamp="2026-01-01T12:00:00Z"),
        make_scored(message_id=2, score=0.4, timestamp="2026-01-01T12:10:00Z"),
    ]
...
def test_window_ids_sequential():
    messages = [
        make_scored(message_id=1, timestamp="2026-01-01T08:00:00Z"),
        make_scored(message_id=2, timestamp="2026-01-01T20:00:00Z"),
        make_scored(message_id=3, timestamp="2026-01-02T10:00:00Z"),
    ]
    windows = create_windows(messages, gap_hours=4)
...
def test_target_author_id_sets_is_target_user():
    messages = [
        make_scored(message_id=1, author_id=100, timestamp="2026-01-01T12:00:00Z"),
        make_scored(message_id=2, author_id=200, timestamp="2026-01-01T12:05:00Z"),
    ]
...
def test_inject_reply_context_missing_parent():
    ...
    messages = [
        make_scored(message_id=2, reply_to_id=999, timestamp="2026-01-01T12:05:00Z"),
    ]
    windows = create_windows(messages)
